    ...
    <Link href={"/video/" + data?.video_id} key={key}>
      <div className="flex transition duration-150 cursor-pointer  hover:bg-white dark:hover:bg-stone-900 py-1 justify-start items-start space-y-2">
        <div className="w-full h-full flex justify-start">
          <div className="relative w-[45%] bg-stone-200 rounded-lg dark:bg-stone-700 h-[80px]">
            {/* <!-- Image Video --> */}
            <a href="#">
              <Image
                src={
                  data?.video_metadata?.items[0].snippet.thumbnails.medium.url
                }
                layout={"fill"}
          ...
          <div className="w-[55%] flex text-xs mx-2 dark:text-stone-100 text-gray-900 flex-col justify-around">
