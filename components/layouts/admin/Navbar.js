...
export default function Navbar() {
  return (
    <div className="w-full relative">
      <nav className=" bg-white w-full border-gray-400 border-t z-30 relative flex justify-between items-center mx-auto pl-8 pr-14 py-3">
        <div className="flex justify-center items-center">
          <Link href="/">
            <p className="text-xl cursor-pointer font-medium text-red-600">
              Panel Admin
            </p>
          </Link>
        </div>
