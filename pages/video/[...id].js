...
import CardSpecialVideoSkeleton from "@/components/cards/CardSpecialVideoSkeleton";
import CardSpecialVideo from "@/components/cards/CardSpecialVideo";
  ...
  const getCategoryVideos = async () => {
    try {
      ...
      const response = await axios.get(
        `https://rasmlink.ir/api-v1/youtube_videos?video_categories_ids=${video?.video_categories_ids}&is_special=true`,
        {
          headers: {
      ...
      <Main hiddenSidebar={true}>
        <div className="flex w-full lg:flex-row flex-col-reverse items-cenetr relative">
          ...
          <div className="w-full lg:w-[75%] lg:p-2 h-full relative">
            ...
            <button
              type="button"
              onClick={() => console.log(video.video_categories_ids)}
            >
              click
            </button>
            {/* Details Video Description */}
            <div className="w-full mt-6" dir="ltr">
              <div className="flex md:flex-row flex-col justify-between md:space-y-1 space-y-3 border-b border-gray-300 dark:border-stone-600 pb-2">
                <div className="flex flex-col pb-2 jsutify-between">
                  <div className="flex flex-col w-full">
                    <h3 className="md:text-md text-sm text-gray-900 dark:text-stone-200">
              ...
              <div className="mt-4">
                    ...
                    <div className="flex justify- items-center">
                      <div className="">
                        <Image
                          ...
                          height={"48"}
                          src={
                            video.video_metadata.items[0].snippet.thumbnails
                              .medium.url
                          }
                          alt="picture user"
                      ...
                      <div className="flex mx-3 flex-col justify-center items-start mb-1">
                        <p className="text-gray-800 dark:text-stone-200 capitalize md:text-md text-sm mb-1">
                          {video.video_metadata.items[0].snippet.channelTitle}
                        </p>
                        {/* <p className="text-gray-800 dark:text-stone-200 capitalize md:text-sm text-xs">281k follow</p> */}
                      </div>
                    </div>
                  </Link>
                ...
                <div className="m-3 mt-6 w-full">
                  <p className="flex w-4/6 leading-8 h-full relative text-gray-800 dark:text-stone-200  font-base md:text-md text-sm">
                    {
                      video.video_metadata.items[0].snippet.localized
                        .description
                    }
                  </p>
                </div>
          ...
          <div className="w-full lg:w-[30%] h-full relative lg:p-2">
            <div className="w-full text-xs bg-white dark:bg-stone-800 border border-gray-300 dark:border-stone-600">
              <div className="w-full border-b border-gray-300 dark:border-stone-600 p-4">
                <div className="flex items-center text-gray-600 dark:text-stone-100">
                  <p className="font-medium text-sm mx-2">
                    {getPlaylist[0].playlist_metadata.snippet.channelTitle}
                  </p>
                </div>
                <div className="mt-2 w-full flex justify-end items-center text-gray-600">
                  {/* <p className='text-gray-700 text-xs mx-4 dark:text-stone-100'>samansayyar 1/8</p> */}
                </div>
                <div className="mt-4 w-full hidden justify-between items-center text-gray-600 dark:text-stone-100">
                  <div>
                    <svg
                      className="w-5 h-5"
                      fill="none"
