...
export default function List() {
  ...
  return (
    <div>
      <Head>
        <title>لینک های من - پنل کاربری</title>
      </Head>
      <Header>
        <div className="grid grid-cols-12 gap-6 mt-3">
          <div className="inline-block w-full col-span-5">
            <div className="inline-flex items-center max-w-full">
              <button
                className="flex items-center flex-grow-0 bg-white flex-shrink pl-2 relative border rounded-xl px-1"
                type="button"
              >
          ...
          <div className="col-span-12 p-6 bg-white dark:bg-stone-800 rounded-md shadow-md">
                    ...
                    <table className="w-full table-auto">
                      ...
                      <tbody className="text-sm divide-y divide-gray-100">
                        <tr>
                          ...
                          <td className="p-2 whitespace-nowrap">
                            <div className="font-medium text-yellow-400 text-sm text-center">
                              درحال بررسی
                            </div>
                          </td>
                          <td className="p-2 whitespace-nowrap">
