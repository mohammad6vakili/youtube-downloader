...
export default function Index() {
  ...
  return (
    <div>
      <Head>
        <title>ویرایش لینک - پنل کاربری</title>
      </Head>
      <Header>
        <div className="grid grid-cols-12 gap-6 mt-3">
          <div className="col-span-8 p-6 bg-white dark:bg-stone-800 rounded-md shadow-md">
            ...
            <div className="my-6">
              ...
              <div className="mt-10">
                ...
                <div className="flex flex-col items-start justify-center space-y-4">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="text-sm text-gray-700">
                      {" "}
                      ✅ دسترسی به محتوای لینک از منبع اصلی
                    </div>
                  </div>
                  <div className="flex items-center space-x-3">
                    <div></div>
                    <div className="text-sm text-gray-700">
                      {" "}
                      ✅ دسترسی به محتوای از آدرس جدید به سرعت بالا 🔥
                    </div>
                  </div>
                </div>
                ...
                <div className="text-sm flex items-center">
                  ...
                  <div className="font-meidum text-gray-900">
                    &nbsp; این دامین مورد تایید است &nbsp;
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="col-span-4 p-6 bg-white rounded-md shadow-md">
            <div className="pb-4 border-b border-gray-200 w-full font-medium">
              اشتراک شما
            </div>

            <div className="w-full flex justify-center h-full flex-col items-center">
              <div className="text-md text-gray-900">
                تعداد لینک های باقی مانده
              </div>
              <div className="my-2 font-medium lg:text-5xl text-2xl text-gray-900 font-sans">
                9
              </div>
              <span className="text-red-500 text-lg mr-1 font-medium">
                لینک
              </span>
            </div>
          </div>
          <div className="col-span-7 rounded-md"></div>
                  ...
                  <table className="w-full table-auto">
                    ...
                    <tbody className="text-sm divide-y divide-gray-100">
                      <tr>
                        ...
                        <td className="p-2 whitespace-nowrap">
                          <div className="font-medium text-yellow-400 text-xs">
                            درحال بررسی
                          </div>
                        </td>
                      </tr>
