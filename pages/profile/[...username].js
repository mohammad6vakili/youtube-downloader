  ...
  return (
    <div className="relative">
      ...
      <Main withoutPadding={true}>
        ...
        <div
          dir="ltr"
          className="mt-6 pl-20 pr-10 w-full pb-10 text-gray-600 dark:text-stone-300"
        >
          {/* Videos */}
          {AllVideo.length > 0 ? (
...
export async function getServerSideProps({ params }) {
  ...
  const ResVideoProfile = await fetch(
    `https://rasmlink.ir/api-v1/youtube_videos?video_channel_id=${username[0]}&is_special=false&is_verfied=true&offset=1&limit=20`,
    {
      headers: {
        Authorization: "010486ba-0e8a-4382-a47f-d888baac5b5c",
      },
